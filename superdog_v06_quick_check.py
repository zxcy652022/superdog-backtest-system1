...
def quick_validation():
    ...
    checks = [
        ...
        ("execution_engine/experiment_runner.py", check_module_exists("execution_engine/experiment_runner.py")),
        ("execution_engine/parameter_optimizer.py", check_module_exists("execution_engine/parameter_optimizer.py")),
        ("execution_engine/result_analyzer.py", check_module_exists("execution_engine/result_analyzer.py")),
    ]
    ...
    checks = [
        ("execution_engine/execution_model.py", check_module_exists("execution_engine/execution_model.py")),
        ("execution_engine/fee_models.py", check_module_exists("execution_engine/fee_models.py")),
        ("execution_engine/slippage_models.py", check_module_exists("execution_engine/slippage_models.py")),
        ("execution_engine/funding_models.py", check_module_exists("execution_engine/funding_models.py")),
        ("execution_engine/liquidation_models.py", check_module_exists("execution_engine/liquidation_models.py")),
    ]
    ...
    checks = [
        ("risk_management/support_resistance.py", check_module_exists("risk_management/support_resistance.py")),
        ("risk_management/dynamic_stops.py", check_module_exists("risk_management/dynamic_stops.py")),
        ("risk_management/risk_calculator.py", check_module_exists("risk_management/risk_calculator.py")),
        ("risk_management/position_sizer.py", check_module_exists("risk_management/position_sizer.py")),
